    ...
    useEffect(() => {
        ...
        async function getBookDetails() {
            try {
                ...
                if (data) {
                    const { author, cover, detail, genre, title, book_id } = data;
                    const newBook = {
        ...
        <section className="book-details">
            ...
            <div className="book-details-content grid">
                <div className="book-details-img">
                    <img
                        src={book?.cover_img}
                        alt="Book Cover (Image Not Found)" // Informative alt text for accessibility
                        onError={(event) => {
                ...
                <div className="book-details-info">
                    <div className="book-details-item title">
                        <span className="fw-6 fs-24">{(`(id:${book?.book_id}) `)}{book?.title}</span>
                    </div>
